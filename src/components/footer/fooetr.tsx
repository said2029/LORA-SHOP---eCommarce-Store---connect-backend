...
export default function Fooetr() {
  ...
  return (
    <>
      {!UtlAuthPage && (
        <footer className="bg-stone-100 mt-10">
          <div className="mx-auto max-w-screen-xl px-4 pb-6 pt-16 sm:px-6 lg:px-8">
            <div className="lg:flex lg:items-center lg:justify-between ">
              <div className="flex flex-col justify-center items-center text-teal-600 sm:justify-start gap-5">
                ...
                <p className="text-center text-pretty leading-relaxed text-gray-500 ltr:sm:text-left rtl:sm:text-right">
                  join the 555+ people that Uses Softion Products
                </p>
              </div>
            ...
            <div className="mt-16 grid grid-cols-1 gap-10 border-t border-gray-100 pt-16 md:grid-cols-4">
              ...
              <div className="text-center sm:text-left">
                ...
                <div className="flex gap-3 mt-3 text-sm">
                  <ul className="flex flex-wrap items-center justify-center  md:justify-start gap-4">
                    ...
                    <li>
                      <a
                        className="text-gray-700 transition hover:text-gray-700/75 basis-1/4"
                        href="#"
                      >
                        headphone
                      </a>
              ...
              <div className="text-center sm:text-left">
                <p className="text-lg font-medium text-gray-900">Hello Center</p>
