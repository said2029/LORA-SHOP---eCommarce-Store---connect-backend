...
export default function ExploreSale(prop: { tital: string; subtital: string }) {
  ...
  return (
    <Container maxWidth="xl" className="flex flex-col justify-center items-center my-7 px-3">
      ...
      {/* Cards */}
      <div className="grid grid-cols-1 mt-10 justify-center items-center mx-auto gap-4 w-full sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5">
